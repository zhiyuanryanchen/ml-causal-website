...
# 从估计工具到研究 workflow {background-color="#AE0B2A"}
...
# AI 辅助的因果分析工作流 {background-color="#AE0B2A"}

## 从研究问题到可复现实验

![](../Figures/lecture12_workflow_pipeline.png){width="90%"}
...
```text
Prompt: 你是我的研究协作者。请不要直接给结论，而是先输出：
1. 处理变量、结果变量、候选混杂变量
2. 识别风险与不能控制的变量
3. 数据审计步骤
...
这样能快速看到哪些论文是**随机实验**、哪些是**工具变量**、哪些是**DML**。
:::
...
![](../Figures/lecture12_verify_loop.png){width="70%"}
...
# 从 workflow 到终极追问 {background-color="#AE0B2A"}
